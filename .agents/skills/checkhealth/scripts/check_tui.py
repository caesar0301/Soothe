...
def check_tui_imports() -> dict[str, Any]:
    ...
    try:
        ...
        from soothe.cli.tui_shared import TuiState, render_plan_tree
...
def check_slash_commands() -> dict[str, Any]:
    ...
    try:
        from soothe.cli.commands import SLASH_COMMANDS
...
def check_tui_widgets() -> dict[str, Any]:
    ...
    try:
        ...
        from soothe.cli.tui_app import (
            ActivityPanel,
            ChatInput,
            ConversationPanel,
            InfoBar,
...
def check_input_history() -> dict[str, Any]:
    ...
    try:
        from soothe.cli.tui_app import ChatInput
