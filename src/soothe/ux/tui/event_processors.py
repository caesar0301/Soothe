...
from soothe.ux.shared.rendering import _resolve_namespace_label
...
if TYPE_CHECKING:
    from soothe.ux.tui.widgets import ActivityInfo
...
class _TuiOutputFormatter(OutputFormatter):
    ...
    def emit_assistant_text(self, text: str, *, is_main: bool) -> None:
        ...
        if not is_main:
            ...
            from soothe.ux.tui.renderers import _add_activity_from_event
